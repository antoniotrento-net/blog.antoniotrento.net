...
description: "Hai pagato un sito bello, ma appena un cliente torna, ordina o carica un file, si rompe: non tiene uno stato. La differenza tra un sito vetrina e un prodotto digitale vero — e come briefare chi deve costruirlo."
keywords: ["sito vetrina vs prodotto digitale", "agenzia web senza backend", "app su misura vs wordpress", "prodotto digitale pmi", "form al posto del gestionale"]
image: /assets/images/posts/sito-vetrina-vs-prodotto-digitale.jpg
pillar: web-prodotto
related: [/it/blog/lanciare-prodotto-ai-white-label/, /it/blog/portale-b2b-clienti/]
---
...
È lo stesso muro dell'80% che si incontra con [ogni scorciatoia pronta]({{ '/it/pillar/portali-b2b/' | relative_url }}), e la regola per decidere è sempre quella: quanto del valore del tuo prodotto sta in quel 20% che il pronto non fa? Se ci sta il cuore del tuo modo di lavorare, il no-code è una trappola che scopri tardi. Se invece ti serve una cosa standard e lineare, il no-code va benissimo e sarebbe sciocco spendere di più — anche questo fa parte dell'onestà.
...
Login, elenco, dettaglio, azione: se un progetto "web" non ha questi quattro elementi, quasi certamente stai comprando una vetrina, non un prodotto. E se il tuo business ha bisogno che i clienti *facciano* cose online, ti serve la seconda. È lo stesso scheletro che regge [un prodotto AI vendibile]({{ '/it/blog/lanciare-prodotto-ai-white-label/' | relative_url }}) o qualsiasi software serio: l'interfaccia bella è la superficie, ma sotto ci sono utenti, dati e azioni, o non è un prodotto.
...
Se hai una vetrina e sospetti che ti serva un prodotto, guarda i [progetti che ho costruito]({{ site.main_site }}/portfolio/) o [scrivimi due righe]({{ site.main_site }}/contatti/): partiamo dalle operazioni che devono avvenire online e dai dati che hai già, non da un tema grafico.
